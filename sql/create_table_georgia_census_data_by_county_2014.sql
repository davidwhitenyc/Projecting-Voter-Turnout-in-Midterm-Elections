----pull 2014 acs census data from BigQuery public data for the state of Georgia by county and save the results in a new table----
CREATE OR REPLACE TABLE `political-data-354221.census_data.georgia_census_data_by_county_2014` AS
